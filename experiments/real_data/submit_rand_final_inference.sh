...
export MIXGLM_INFERENCE_OUTPUT_ROOT=experiments/real_data/targeted_outputs/rand_final_inference_v1
export MIXGLM_INFERENCE_DATASET=randhealth_notmdvis_baseline
export MIXGLM_INFERENCE_P_SCREEN=50
export MIXGLM_INFERENCE_LAMBDAS=0,2,5,10,25,50,100,250,500,1000
