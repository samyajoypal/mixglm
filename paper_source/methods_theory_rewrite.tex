...
For penalized fits we use the active-set analogue
\[
    \hat a_{\mathfrak m}
    =
    (K-1)
...
\]
as a computational model-selection score.  This active-set BIC is a heuristic
unless an additional post-selection theory is supplied.
